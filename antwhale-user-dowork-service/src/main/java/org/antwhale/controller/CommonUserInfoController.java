...
public class CommonUserInfoController {
     ...
     **/
    @GetMapping("/userinfo/userCourseQuery")
    public ResultVo queryUserCourse(@RequestParam("userId") String userId) {
        List<EduCourseUser> eduCourseUserList = commonUserInfoBPO.queryUserCourse(userId);
        return ResultVo.ok(eduCourseUserList,"查询成功");
    }
